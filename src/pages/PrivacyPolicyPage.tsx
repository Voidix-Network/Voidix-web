          ...
          <div className="flex-1">
            ...
            <div className="space-y-2 mb-6">
              ...
              <p className="text-gray-300">
                ...
                <span
                  className={
                    consent.marketing ? 'text-green-400 font-bold' : 'text-red-400 font-bold'
                  }
                >
...
export const PrivacyPolicyPage: React.FC = () => {
  ...
  const sections = [
    ...
    },
    {
      icon: Cookie,
      title: 'Cookie及类似技术政策',
      content: `我们使用Cookie来运营和改善我们的网站。Cookie是存储在您设备上的小文本文件。我们主要使用以下三类Cookie：
      ...
      • 营销Cookie：这些Cookie可能由我们的广告合作伙伴设置，用于建立您的兴趣画像并向您展示相关广告。我们目前暂未使用此类Cookie，但未来可能会引入。
