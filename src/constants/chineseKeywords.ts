...
export const PAGE_KEYWORDS_CONFIG: Record<string, PageKeywords> = {
  home: {
    ...
    keywords: {
      primary: [
        'Voidix', 'Minecraft服务器', '中文公益社区', '免费小游戏服务器', '我的世界联机平台',
        '公益服务器', '公平游戏', '包容社区', '开放服务器', '公益服务器推荐', '免费公益服务器', '公益服列表', '如何加入公益服务器', '我的世界公益服玩法', '我的世界公益服推荐', '公益服务器有哪些', '我的世界公益服服务器'
      ],
      secondary: [
        'Minecraft小游戏', 'MC小游戏服务器', '我的世界联机', '无氪金', '互助', '透明', '责任', '社区自治', '反作弊', '绿色游戏', '开放社区',
        '新手友好', '技术分享', '玩法攻略', '社区共建', '无障碍', '多元包容', '公益活动', '玩家互助', '开放源码', '安全合规'
      ],
      longTail: [
        '公益Minecraft服务器', '公平的我的世界小游戏', '包容开放的MC社区', '无氪金MC服务器', '公益游戏服务器推荐',
        '最好玩的Minecraft服务器', '免费的我的世界小游戏', '中文Minecraft服务器推荐', 'Voidix服务器在线状态查询', 'MC服务器实时监控', 'Voidix服务器运行时间查询', 'MC服务器稳定性监控', '服务器历史运行数据', '如何报告Minecraft服务器Bug', 'Voidix客服联系方式', 'MC新手入门指南', 'Voidix服务器教程', '如何加入Minecraft服务器', 'MC服务器帮助', '游戏规则', '连接教程', '游戏模式介绍', '小游戏规则', '中文教程', '国服连接方法', '服务器性能', '游戏延迟', '连接状态', '国服状态', '中文服务器监控', '服务器运行时间', '可用性统计', '服务器健康状态', '系统监控', '国服监控', '中文服务器监控系统', '服务器状态页面'
      ],
